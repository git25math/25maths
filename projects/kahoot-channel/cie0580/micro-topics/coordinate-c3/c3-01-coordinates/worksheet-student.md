...
## Model example
Example: mean of `[15, 14, 13, 9, 4]` is `55/5 = 11.0`.

## Practice (10)
1. Find mean of `[19, 18, 18, 13, 16]`.
2. Find median of `[13, 16, 18, 18, 19]`.
3. Find range of `[19, 18, 18, 13, 16]`.
4. A fair die is rolled. Find `P(score > 3)`.
5. If `P(A)=0.7`, find `P(not A)`.
6. Expected frequency if probability is `0.3` in `56` trials.
