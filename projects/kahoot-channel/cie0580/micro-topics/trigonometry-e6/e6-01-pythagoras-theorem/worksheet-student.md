...
## Syllabus focus
- Apply pythagoras theorem methods accurately in CIE 0580 Extended exam questions.

## Model example
Example: mean of `[7, 17, 18, 7, 16]` is `65/5 = 13.0`.

## Practice (10)
1. Use Pythagoras to find hypotenuse when legs are `6` and `9`.
2. Find `sin 30°`.
3. Find `cos 60°`.
4. Find `tan 45°`.
