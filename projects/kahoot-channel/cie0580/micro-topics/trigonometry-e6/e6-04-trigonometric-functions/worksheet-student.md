...
## Syllabus focus
- Apply trigonometric functions methods accurately in CIE 0580 Extended exam questions.

## Model example
Example: mean of `[13, 5, 17, 10, 9]` is `54/5 = 10.8`.

## Practice (10)
1. Use Pythagoras to find hypotenuse when legs are `4` and `5`.
2. Find `sin 30°`.
3. Find `cos 60°`.
4. Find `tan 45°`.
...
9. State the cosine rule formula for side `a`.
