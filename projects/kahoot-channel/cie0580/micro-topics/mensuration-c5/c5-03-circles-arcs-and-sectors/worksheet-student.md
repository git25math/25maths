...
## Syllabus focus
- Apply circles, arcs and sectors methods accurately in Edexcel 4MA1 Higher exam questions.

## Model example
Example: mean of `[17, 10, 16, 17, 11]` is `71/5 = 14.2`.

## Practice (10)
1. Find mean of `[5, 12, 10, 12, 13]`.
2. Find median of `[5, 10, 12, 12, 13]`.
3. Find range of `[5, 12, 10, 12, 13]`.
4. A fair die is rolled. Find `P(score > 2)`.
5. If `P(A)=0.7`, find `P(not A)`.
6. Expected frequency if probability is `0.3` in `52` trials.
