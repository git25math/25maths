...
|---|---|---|---|---|---|---|---|
| 1 | Find third angle in a triangle with angles `39°` and `64°`. | 79 | 77 | 76 | 78 | B | Fluency |
| 2 | Find sum of interior angles of a `8`-sided polygon. | 1080 | 1081 | 1079 | 1082 | A | Fluency |
| 3 | State the order of rotational symmetry of a regular hexagon. | 7 | 6 | 5 | 8 | B | Fluency |
| 4 | Find perimeter of rectangle `15 cm` by `19 cm`. | 0 | Cannot be determined | No solution | 68 cm | D | Fluency |
| 5 | Find area of circle radius `6 cm` in terms of `pi`. | Cannot be determined | No solution | 0 | 36pi cm^2 | D | Fluency |
| 6 | Use Pythagoras: legs `3` and `5`. | Cannot be determined | 0 | sqrt(34) | No solution | C | Method |
