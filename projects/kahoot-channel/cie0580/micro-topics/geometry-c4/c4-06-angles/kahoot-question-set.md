...
|---|---|---|---|---|---|---|---|
| 1 | Find third angle in a triangle with angles `52°` and `56°`. | 71 | 74 | 72 | 73 | C | Fluency |
| 2 | Find sum of interior angles of a `9`-sided polygon. | 1262 | 1261 | 1259 | 1260 | D | Fluency |
| 3 | State the order of rotational symmetry of a regular hexagon. | 7 | 6 | 8 | 5 | B | Fluency |
| 4 | Find perimeter of rectangle `9 cm` by `13 cm`. | Cannot be determined | No solution | 0 | 44 cm | D | Fluency |
| 5 | Find area of circle radius `10 cm` in terms of `pi`. | 100pi cm^2 | 0 | No solution | Cannot be determined | A | Fluency |
| 6 | Use Pythagoras: legs `4` and `10`. | Cannot be determined | 0 | sqrt(116) | No solution | C | Method |
