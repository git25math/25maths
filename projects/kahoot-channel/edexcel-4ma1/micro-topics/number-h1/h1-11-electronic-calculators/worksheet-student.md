...
## H1.11 Electronic calculators

Name: ____________________   Date: ____________________

## Syllabus focus
- Apply electronic calculators methods accurately in Edexcel 4MA1 Higher exam questions.

## Model example
Example: increase `80` by `17%`: compute `80 x (1 + 17/100)` to get `93.6`.

## Practice (10)
1. Evaluate `28 + 14 x 6`.
2. Write `5/24 + 13/24` as a simplified fraction.
3. Calculate `2.2 + 0.30`.
4. Work out `5^6`.
5. Find `sqrt(36)`.
6. Increase `120` by `30%`.
7. Share `60` in the ratio `2:3` and give the larger share.
8. Round `113.5` to `4` significant figures.
