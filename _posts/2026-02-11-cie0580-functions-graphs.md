...
3) **Understanding gradient and intercept**  
4) **Interpreting real‑life graphs**

## Fast improvement tips
**Tip 1: Use a clear scale.**  
If the scale is wrong, the whole question collapses.

**Tip 2: Plot points first, draw later.**  
Always mark points before drawing the line or curve.

**Tip 3: Check for reasonableness.**  
If a value is outside the graph, you misread the axis.

## Practice strategy
Do 5–8 short questions daily instead of one long worksheet.  
