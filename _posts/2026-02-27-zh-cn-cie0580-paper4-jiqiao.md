...
description: "CIE 0580 Paper 4 Extended 高分技巧：10 个针对常见失分场景的答题策略，帮你多拿 20+ 分。适合正在备考的 Y10-Y11 学生。"
...
Paper 4（Extended）是 CIE 0580 中最长、权重最高的试卷。$2$ 小时 $30$ 分钟完成 $130$ 分，节奏和技巧与知识同样重要。

以下是帮助学生多拿 $20$+ 分的 $10$ 个具体技巧。
...
Paper 4 不要求按顺序作答。先花 $2$ 分钟浏览所有题目，然后从你最熟悉的主题开始。早期的信心会改善后面难题的表现。
...
解完方程后，**把答案代回原方程**。
这只需 $30$ 秒，却能发现每道题可能丢 $2$–$3$ 分的符号错误。
...
- 从题目或表格中读取 $n$
- 检查你的累积频率终值是否等于 $n$
- 中位数：用 $\frac{n}{2}$（分组数据不用 $\frac{n+1}{2}$）
...
搞混方向（$A \to B$ vs $B \to A$）是向量题的头号错误。

## 10) 最后10分钟用来检查

**不要**在最后 $10$ 分钟开始做新题，除非你真的已经做完了。
